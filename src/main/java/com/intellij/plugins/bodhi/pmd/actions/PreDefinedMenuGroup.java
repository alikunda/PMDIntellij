...
public class PreDefinedMenuGroup extends ActionGroup {
    ...
    private DefaultActionGroup children = new DefaultActionGroup("Run DCD", true);
...
//            children.add(action);
            ...
            for (int i=0; i < rulesetFilenames.length; ++i) {
                ...
                String ruleName = PMDUtil.getBareFileNameFromPath(ruleFileName);

                System.out.println("****" + ruleFileName + "  **" + ruleName);
                if (ruleName.equals("category/java/bestpractices")) {
